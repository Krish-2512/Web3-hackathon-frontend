	...
	return (
		...
		<div className="footer_container">
            ...
            <div className="developers_1">
                ...
                <div className="developers">
                    <div className="developers_a">
                        <div className="names">Kanishk Gadiya</div>
                        <div className="names">Krish Raj</div>
        ...
        <div style={{color:'white', textAlign:'center', fontWeight:'600', borderTop:'2px solid white', padding:'1vh'}}>&copy; 2024  All Rights Reserved.</div>
        </div>
	);
};
export default Footer;