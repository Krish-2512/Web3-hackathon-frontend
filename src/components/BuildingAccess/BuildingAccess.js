    ...
    <div className="landingPg">
      ...
      <div className="inputs">
        ...
        <div className="add-property-form hello">
          <h1 className="hello2">Add Your Resorts for stay</h1>
          <input
            type="text"
            value={propertyID}
        ...
        <div className="add-property-form hello">
          <h1 className="hello2">Grant Entries to Resort</h1>
          <input
            type="text"
            value={propertyID2}
      ...
      <div className="property-sections">
        <div className="property-heading">
          <div className="Perm-Heading">Resorts registered</div>
        </div>
      ...
      <div>
        ...
        <div className="down">
          <div className="hello add-property-form hey">
            <h1 className="hello2">Get Who Have Visited your Resort</h1>
            <br />
          ...
          <div className="hello add-property-form hey">
            <h1 className="hello2">Allowed individual to resort</h1>
            <br />
            <div className="input_wrapper">
              <input
                type="text"
            ...
            {!isEligible && (
              ...
              >
                Not eligible to enter into any resort own by you!
              </div>
            )}
          </div>
        </div>
